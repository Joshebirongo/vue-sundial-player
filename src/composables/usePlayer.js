...
// State: shared singeleton across every component
const queue =  ref([...trackList]);
const currentIndex = ref(0);
const isPlaying = ref(false);
const progress = ref(0); // Seconds elapsed in the current track
...
export default function usePlayer() {
    ...
    return {
        queue, currentIndex, currentTrack, isPlaying, progress, volume, progressPercent,
        formattedProgress, formattedDuration, play, pause, toggle, next, prev, seekTo, setVolume, formatTime
    }
}